...
RUN mkdir /usr/local/lib/python3.8/site-packages && touch /usr/local/lib/python3.8/site-packages/_manylinux.py && echo 'manylinux1_compatible = True' > /usr/local/lib/python3.8/site-packages/_manylinux.py
